				...
				fields: {					
					'email': {
                        validators: {
                            regexp: {
                                regexp: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
                                message: 'Deger gecerli bir e-posta adresi degil',
                            },
							notEmpty: {
                ...
                if (status == 'Valid') {
                    ...
                    axios.post('/your/ajax/login/url', {
                        ...
                        if (response) {
                            ...
                            // Show error popup. For more info check the plugin's official documentation: https://sweetalert2.github.io/
                            Swal.fire({
                                text: "Maalesef email veya parola geçerli deðil, lütfen tekrar deneyin.",
                                icon: "error",
                                buttonsStyling: false,
                                confirmButtonText: "Tamam!",
                                customClass: {
