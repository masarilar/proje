...
(function ($) {
    ...
    $.fn.fileinputLocales['tr'] = {
        ...
        pauseLabel: 'Duraklat',//'Pause',
        pauseTitle: 'Devam eden yüklemeyi duraklat',//'Pause ongoing upload',
        uploadLabel: 'Yükle',
        uploadTitle: 'Seçilen dosyaları yükle',
        msgNo: 'Hayır',
        msgNoFilesSelected: '',
        msgPaused: 'Durduruldu',//'Paused',
        ...
        msgTotalFilesTooMany: 'En fazla <b>{m}</b> adet dosya seçebilirsiniz. (<b>{n}</b> adet dosya seçildi).',//'You can upload a maximum of <b>{m}</b> files (<b>{n}</b> files detected).',
        ...
        msgUploadResume: 'Yüklemeye devam et &hellip;',//'Resuming upload &hellip;',
        msgUploadEmpty: 'Yüklemek için geçerli veri mevcut değil.',
        msgUploadError: 'Yükleme Hatası',//'Upload Error',
        msgDeleteError: 'Silme Hatası',//'Delete Error',
        ...
        msgDuplicateFile: "{name} dosyası önceden eklenmiştir. Tekrar eklenemez.",//'File "{name}" of same size "{size} KB" has already been selected earlier. Skipping duplicate selection.',
        msgResumableUploadRetriesExceeded:  '{max} kez yükleme başarısız olduğundan işlem iptal edilmiştir. Hata Detayı: <pre>{error}</pre>.',//'Upload aborted beyond <b>{max}</b> retries for file <b>{file}</b>! Error Details: <pre>{error}</pre>',
        msgPendingTime: '{time} kaldı.',//'{time} remaining',
        msgCalculatingTime: 'kalan süre hesaplanıyor',//'calculating time remaining',
        ajaxOperations: {
