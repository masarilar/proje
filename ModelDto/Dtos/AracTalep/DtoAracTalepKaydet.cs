...
{
    public class DtoAracTalepKaydet
    {
    ...
    public class DtoAracTalepKaydetValidator : AbstractValidator<DtoAracTalepKaydet>
    {
        public DtoAracTalepKaydetValidator()
        {
           ...
           .MaximumLength(250).WithMessage("Toplam Kilometre 250 karakterden uzun olamaz");
            ...
            //RuleFor(e => e.TalepDurum).IsInEnum().NotEmpty().WithMessage("Talep Durum boş bırakılamaz.");
        }
    }
}
